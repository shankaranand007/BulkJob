...
/*==============Start==============SearchCluseterLP()===========Start==================*/
	...
	SPHINXLBIPCONF['SPX_SEARCH_LB'] = '192.168.20.52',// -sphinxgetDomainInfo - sphinxViewProfileGetDomainInfo
	SPHINXLBIPCONF['VIEWPROFILELB_SPHINXRC2'] = '192.168.20.52', //-- getViewProfileDomainInfo	
...
/*==============Start==============SearchCluseter()===========start==================*/
	...
	APPSPHINXIPCONF['DB3_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX12_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX14_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX15_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX16_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX17_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX25_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX26_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX30_SPHINXRC2'] = '192.168.20.52';
	
	APPSPHINXIPCONF['SPX36_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX37_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX39_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['SPX40_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['LoadBalancer_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['VIEWPROFILELB_SPHINXRC2'] = '192.168.20.52';
	//APPSPHINXIPCONF['SPHINX_SEO_LB'] = '192.168.20.164', //- sphinxSeoGetDomainInfo
	APPSPHINXIPCONF['SPX10_RC2'] = "192.168.20.52";
	APPSPHINXIPCONF['SPX10_LB'] = "192.168.20.52";
	APPSPHINXIPCONF['SPHINX_SEO1'] = "192.168.20.52";
	APPSPHINXIPCONF['SPHINX_SEO2'] = "192.168.20.52";
...
/*================================ComNotInfoCluseter()=========Start================*/
	...
	APPSPHINXDBCONIP['DB1_SPHINXTRANS'] = "192.168.20.54"; //HPUSA
	APPSPHINXDBCONIP['DB2_SPHINXTRANS'] = "192.168.20.54"; //KTY
	APPSPHINXDBCONIP['DB3_SPHINXTRANS'] = "192.168.20.54"; //BGR
	APPSPHINXDBCONIP['DB4_SPHINXTRANS'] = "192.168.20.54"; //MD
	APPSPHINXDBCONIP['DB5_SPHINXTRANS'] = "192.168.20.54"; //EC
	...
	APPSPHINXDBCONIP['DB1_LB_SPHINXTRANS'] = '192.168.20.53';
	APPSPHINXDBCONIP['DB2_LB_SPHINXTRANS'] = '192.168.20.53';
	APPSPHINXDBCONIP['DB3_LB_SPHINXTRANS'] = '192.168.20.53';
	APPSPHINXDBCONIP['DB4_LB_SPHINXTRANS'] = '192.168.20.53';
	APPSPHINXDBCONIP['DB5_LB_SPHINXTRANS'] = '192.168.20.53';
...
/*===============Start=================matchSummaryCluster() & Search LoadBalancer=========Start================*/
	...
	*/
	SPHINXMATCHSUMIP['SphinxMSIP1'] = '192.168.20.162';		//HPUSA
	SPHINXMATCHSUMIP['SphinxMSIP2'] = '192.168.20.162';		//EC
	SPHINXMATCHSUMIP['SphinxMSIP3'] = '192.168.20.162';		//BGR
	SPHINXMATCHSUMIP['SphinxMSIP4'] = '192.168.20.162';		//MD
	SPHINXMATCHSUMIP['SphinxMSIP13'] = '192.168.20.162';	//KTY
	...
	*/	
	SPHINXMATCHSUMIP['SPX4_SPHINXRC2'] = "192.168.20.162";	//HPUSA
	SPHINXMATCHSUMIP['SPX5_SPHINXRC2'] = "192.168.20.162";	//EC
	SPHINXMATCHSUMIP['SPX6_SPHINXRC2'] = "192.168.20.162";	//BGR
	SPHINXMATCHSUMIP['SPX7_SPHINXRC2'] = "192.168.20.162";	//MD
	SPHINXMATCHSUMIP['SPX13_SPHINXRC2'] = "192.168.20.162";	//KTY
	SPHINXMATCHSUMIP['SPX18_SPHINXRC2'] = "192.168.20.162";	//HPUSA
	SPHINXMATCHSUMIP['SPX19_SPHINXRC2'] = "192.168.20.162";	//EC
	SPHINXMATCHSUMIP['SPX20_SPHINXRC2'] = "192.168.20.162";	//BGR
	SPHINXMATCHSUMIP['SPX21_SPHINXRC2'] = "192.168.20.162";	//MD
	SPHINXMATCHSUMIP['SPX22_SPHINXRC2'] = "192.168.20.162";	//KTY
/*===============End=================matchSummaryCluster() & Search LoadBalancer=========End================*/
		
/*===============End=================mvmpCluster() & Members viewed my profile=========End================*/
	//Members viewed my profile
	/*
	...
	*/
	global.SPHINXMVMPIP = {};
	global.SPHINXMVMPPORT = {};
	SPHINXMVMPPORT['SPHINX_PORT'] = 9306;
	SPHINXMVMPIP['SphinxMVMPbmvm'] = "192.168.20.167"; //C - Parsi,K - Kannada,G - Gujarati,M - Tamil,P - Punjabi,S - Sindhi,Y - Oriya
	SPHINXMVMPIP['SphinxMVMPbmvm2'] = "192.168.20.167"; //D - Marwadi, A - Assame, B- Bengali, E - Kerala, U - Urdu, R - Marathi
	SPHINXMVMPIP['SphinxMVMPbmvm3'] = "192.168.20.167"; //H - Hindi, T - Telugu
	
/*===============End=================mvmpCluster() & Members viewed my profile=========End================*/


	//################## For Who Viewed Also Viewed #######################
	global.SPHINXDBCONIP = {};
	global.SPHINXDBCONIPPORT= 9306;
	SPHINXDBCONIP['SphinxWVAVbmVP'] = "192.168.20.167";//tamil - M,Kannda - K,punjabi - P,sindhi - S,Parsi - C
	SPHINXDBCONIP['SphinxWVAVbmVP2'] = "192.168.20.167";//Kerala - E,Bengali - B,Marathi - R,assamese - A,urdu - U
	SPHINXDBCONIP['SphinxWVAVbmVP3'] = "192.168.20.167"; //hindi - H,Telugu - T,marwadi - D,oriya - Y,Gujarati - G 
	//WVAV BMVP2 Server
...
/*===============Start=================OnlineCluseter()=========Start================*/	
	...
	SPHINXONLINDEX['ONLINEMEMBERSDELTASELECTIP'] = '192.168.20.168';
	
	global.SPHINXONLINDEXARR = {};	
	global.SPHINXONLINDEXARRPORT = 9306;
	//################## Online Cluster Segmentation  ############### 	
	SPHINXONLINDEXARR['ONLINEMEMBERSDELTASEGMENTIP'] = ["192.168.20.167","192.168.20.168"];
...
/*===============End=================OnlineCluseter()=========End================*/
	...
	SPHINXLATSTUPIP['SphinxMHCLUSTER_LB_IP'] = "192.168.20.163";//select
	SPHINXLTUPINDEXARR['SphinxMHCLUSTER_IPS'] = ["192.168.20.163","192.168.20.163"];//insert,update 

	SPHINXLATSTUPIP['SphinxMHLU_LB_IP'] = "192.168.20.163"; //select
	SPHINXLTUPINDEXARR['SphinxMHLU_IPS'] =  ["192.168.20.163","192.168.20.163"];//insert,update 
