...
/*==============Start==============SearchCluseterLP()===========Start==================*/
	...
	SPHINXLBIPCONF['SPX_SEARCH_LB'] = '192.168.30.52',// -sphinxgetDomainInfo - sphinxViewProfileGetDomainInfo
	SPHINXLBIPCONF['VIEWPROFILELB_SPHINXRC2'] = '192.168.30.52', //-- getViewProfileDomainInfo	
...
/*==============Start==============SearchCluseter()===========start==================*/
	...
	//APPSPHINXIPCONF['DB1_SPHINXRC2'] = '192.168.20.52';
	//APPSPHINXIPCONF['DB2_SPHINXRC2'] = '192.168.20.52';
	APPSPHINXIPCONF['DB3_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX12_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX14_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX15_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX16_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX17_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX25_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX26_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX30_SPHINXRC2'] = '192.168.30.52';
	
	APPSPHINXIPCONF['SPX36_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX37_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX39_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['SPX40_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['LoadBalancer_SPHINXRC2'] = '192.168.30.52';
	APPSPHINXIPCONF['VIEWPROFILELB_SPHINXRC2'] = '192.168.30.52';
	//APPSPHINXIPCONF['SPHINX_SEO_LB'] = '192.168.20.164', //- sphinxSeoGetDomainInfo
	APPSPHINXIPCONF['SPX10_RC2'] = "192.168.30.169";
	APPSPHINXIPCONF['SPX10_LB'] = "192.168.30.52";
	APPSPHINXIPCONF['SPHINX_SEO1'] = "192.168.30.168";
	APPSPHINXIPCONF['SPHINX_SEO2'] = "192.168.30.168";
	SPHINXIPCONFPORT['SPHINX_PORT'] = 9306;
/*==============End==============SearchCluseter()===========End==================*/
	
/*================================ComNotInfo UPdate()=========Start================*/
	...
	APPSPHINXDBCONIPARR['DB2_SPHINXTRANS'] = ["172.29.23.169","172.29.23.164","172.29.22.50","172.29.22.216","172.29.23.140"]; 
	APPSPHINXDBCONIPARR['DB3_SPHINXTRANS'] = ["172.29.23.167","172.29.23.191","172.29.22.68","172.29.22.218"]; 
	APPSPHINXDBCONIPARR['DB4_SPHINXTRANS'] = ["172.29.23.168","172.29.22.167","172.29.23.11","172.29.22.214","172.29.23.122"]; 
	APPSPHINXDBCONIPARR['DB5_SPHINXTRANS'] = ["172.29.23.166","172.29.23.163","172.29.22.217","172.29.22.69","172.29.23.137","172.29.22.45"]; 
/*================================ComNotInfo UPdate()=========Start================*/

/*================================ComNotInfoCluseter()=========Start================*/
	...
	APPSPHINXDBCONIP['DB1_SPHINXTRANS'] = "192.168.30.54"; //HPUSA
	APPSPHINXDBCONIP['DB2_SPHINXTRANS'] = "192.168.30.54"; //KTY
	APPSPHINXDBCONIP['DB3_SPHINXTRANS'] = "192.168.30.54"; //BGR
	APPSPHINXDBCONIP['DB4_SPHINXTRANS'] = "192.168.30.54"; //MD
	APPSPHINXDBCONIP['DB5_SPHINXTRANS'] = "192.168.30.54"; //EC
	...
	APPSPHINXDBCONIP['DB1_LB_SPHINXTRANS'] = '192.168.30.54';
	APPSPHINXDBCONIP['DB2_LB_SPHINXTRANS'] = '192.168.30.54';
	APPSPHINXDBCONIP['DB3_LB_SPHINXTRANS'] = '192.168.30.54';
	APPSPHINXDBCONIP['DB4_LB_SPHINXTRANS'] = '192.168.30.54';
	APPSPHINXDBCONIP['DB5_LB_SPHINXTRANS'] = '192.168.30.54';
...
/*===============Start=================matchSummaryCluster() & Search LoadBalancer=========Start================*/
	...
	/*
	$APPSPHINXDBCONIP['SphinxMSIP1'] = "172.22.0.54";		//HPUSA
	$APPSPHINXDBCONIP['SphinxMSIP2'] = "172.22.0.55";		//EC
	$APPSPHINXDBCONIP['SphinxMSIP3'] = "172.22.0.56";		//BGR
	$APPSPHINXDBCONIP['SphinxMSIP4'] = "172.22.0.57";		//MD
	$APPSPHINXDBCONIP['SphinxMSIP13'] = "172.22.0.58";		//KTY
	*/
	SPHINXMATCHSUMIP['SphinxMSIP1'] = '192.168.30.162';		//HPUSA
	SPHINXMATCHSUMIP['SphinxMSIP2'] = '192.168.30.162';		//EC
	SPHINXMATCHSUMIP['SphinxMSIP3'] = '192.168.30.162';		//BGR
	SPHINXMATCHSUMIP['SphinxMSIP4'] = '192.168.30.162';		//MD
	SPHINXMATCHSUMIP['SphinxMSIP13'] = '192.168.30.162';	//KTY
		
	//Matchsummary & Search Individual IPs Ignore & Views & Contacts Index Server Variables - sphinxgetDomainInfoListRand
	/*
	$APPSPHINXDBCONIP['SPX4_SPHINXRC2'] = "172.23.0.99";	//HPUSA
	$APPSPHINXDBCONIP['SPX5_SPHINXRC2'] = "172.23.0.97";	//EC
	$APPSPHINXDBCONIP['SPX6_SPHINXRC2'] = "172.23.0.65";	//BGR
	$APPSPHINXDBCONIP['SPX7_SPHINXRC2'] = "172.22.0.64";	//MD
	$APPSPHINXDBCONIP['SPX13_SPHINXRC2'] = "172.23.1.116";	//KTY
	$APPSPHINXDBCONIP['SPX18_SPHINXRC2'] = "172.23.0.132";	//HPUSA
	$APPSPHINXDBCONIP['SPX19_SPHINXRC2'] = "172.29.23.133";	//EC
	$APPSPHINXDBCONIP['SPX20_SPHINXRC2'] = "172.29.23.134";	//BGR
	$APPSPHINXDBCONIP['SPX21_SPHINXRC2'] = "172.29.23.135";	//MD
	$APPSPHINXDBCONIP['SPX22_SPHINXRC2'] = "172.29.23.136";	//KTY
	*/	
	SPHINXMATCHSUMIP['SPX4_SPHINXRC2'] = "192.168.30.162";	//HPUSA
	SPHINXMATCHSUMIP['SPX5_SPHINXRC2'] = "192.168.30.162";	//EC
	SPHINXMATCHSUMIP['SPX6_SPHINXRC2'] = "192.168.30.162";	//BGR
	SPHINXMATCHSUMIP['SPX7_SPHINXRC2'] = "192.168.30.162";	//MD
	SPHINXMATCHSUMIP['SPX13_SPHINXRC2'] = "192.168.30.162";	//KTY
	SPHINXMATCHSUMIP['SPX18_SPHINXRC2'] = "192.168.30.162";	//HPUSA
	SPHINXMATCHSUMIP['SPX19_SPHINXRC2'] = "192.168.30.162";	//EC
	SPHINXMATCHSUMIP['SPX20_SPHINXRC2'] = "192.168.30.162";	//BGR
	SPHINXMATCHSUMIP['SPX21_SPHINXRC2'] = "192.168.30.162";	//MD
	SPHINXMATCHSUMIP['SPX22_SPHINXRC2'] = "192.168.30.162";	//KTY
/*===============End=================matchSummaryCluster() & Search LoadBalancer=========End================*/	
		
/*===============Start=================mvmpCluster() & Members viewed my profile=========Start================*/
	/*
	$APPSPHINXDBCONIP['SphinxMVMPbmvm'] = "192.168.20.167"; //C - Parsi,K - Kannada,G - Gujarati,M - Tamil,P - Punjabi,S - Sindhi,Y - Oriya
	$APPSPHINXDBCONIP['SphinxMVMPbmvm2'] = "192.168.20.167"; //D - Marwadi, A - Assame, B- Bengali, E - Kerala, U - Urdu, R - Marathi
	$APPSPHINXDBCONIP['SphinxMVMPbmvm3'] = "192.168.20.167"; //H - Hindi, T - Telugu	
	*/
	//tamilviewedmyprofilestatsindex8
	global.SPHINXMVMPIP = {};
	global.SPHINXMVMPPORT = 9306;
	SPHINXMVMPIP['SphinxMVMPbmvm'] = "192.168.30.175"; //C - Parsi,K - Kannada,G - Gujarati,M - Tamil,P - Punjabi,S - Sindhi,Y - Oriya
	SPHINXMVMPIP['SphinxMVMPbmvm2'] = "192.168.30.175"; //D - Marwadi, A - Assame, B- Bengali, E - Kerala, U - Urdu, R - Marathi
	SPHINXMVMPIP['SphinxMVMPbmvm3'] = "192.168.30.175"; //H - Hindi, T - Telugu	
...
/*===============Start========== For Who Viewed Also Viewed =========Start================*/
	...
	//SPHINXDBCONIP['SphinxWVAVbmVP'] = "192.168.30.171";//tamil - M,Kannda - K,punjabi - P,sindhi - S,Parsi - C
	//SPHINXDBCONIP['SphinxWVAVbmVP2'] = "192.168.30.171";//Kerala - E,Bengali - B,Marathi - R,assamese - A,urdu - U
	//SPHINXDBCONIP['SphinxWVAVbmVP3'] = "192.168.30.171"; //hindi - H,Telugu - T,marwadi - D,oriya - Y,Gujarati - G 
	//WVAV BMVP2 Server
	//K//14AUG15//$wvavcurlip="115.112.201.241:8080";
	global.wvavcurlip ="192.237.242.179:8080";
	global.$wvavcurlip="172.29.23.174:8080";
...
/*===============Start=================OnlineCluseter()=========Start================*/
	...
	SPHINXONLINDEX['ONLINEMEMBERSDELTASELECTIP'] = '192.168.30.55';
	
	global.SPHINXONLINDEXARR = {};	
	global.SPHINXONLINDEXARRPORT = 9306;
	//################## Online Cluster Segmentation  ############### 	
	SPHINXONLINDEXARR['ONLINEMEMBERSDELTASEGMENTIP'] = ["192.168.30.55","192.168.30.55"];
	//################## Online Cluster Segmentation  ############### 
...
//##################  MYHOME Preferred section(cluster) and latest updates Index Server Variables ################## 
	global.SPHINXLATSTUPIP = {};	
	global.SPHINXLTUPINDEXARR = {};
	SPHINXLATSTUPIP['SphinxMHCLUSTER_LB_IP'] = "192.168.30.169";//select
	SPHINXLTUPINDEXARR['SphinxMHCLUSTER_IPS'] = ["192.168.30.169","192.168.30.169"];//insert,update 

	SPHINXLATSTUPIP['SphinxMHLU_LB_IP'] = "192.168.30.169"; //select
	SPHINXLTUPINDEXARR['SphinxMHLU_IPS'] =  ["192.168.30.169","192.168.30.169"];//insert,update 

	SPHINXDBCONIPPORT = 9306;//myhome command QL port
//##################  MYHOME Preferred sction(cluster) and latest updates Index Server Variables ##################
